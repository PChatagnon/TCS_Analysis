...
double CM_gamma_energy_2(Particle vElectron, Particle vPositron, Particle vProton)
{
...
double CM_E_k_2(Particle vElectron, Particle vPositron, Particle vProton, double Q2)
{
	...
	double E_k = sqrt( (vProton.Vector.E()-vRestProton.E())*(vProton.Vector.E()-vRestProton.E())  - (vProton.Vector-vRestProton).M2() ) - sqrt( (vProton.Vector.E()-vRestProton.E())*(vProton.Vector.E()-vRestProton.E())  - (vProton.Vector-vRestProton).M2() + (-Q2));
	return E_k;
}
